  ...
  <v-layout row>
    <v-flex xs12 md5>
      <panel :title="titleLeft">
        ...
        <v-text-field label="Artiste" v-model="song.artiste" required :rules="[required]"></v-text-field>
        ...
        <v-text-field label="Youtube" v-model="song.youtube" required :rules="[required]"></v-text-field>
      </panel>
    </v-flex>
